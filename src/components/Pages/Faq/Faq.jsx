    ...
    return (
        <div className='lg:py-16 md:py-12 py-8 md:px-0 px-3  max-w-[700px] mx-auto sm:px-0 px-3 '>
            ...
            <div className="page-head flex justify-center items-center pb-8">
                ...
                <div tabindex="0" className="collapse collapse-plus border border-base-300 rounded-box mb-3">
                    <div className="collapse-title text-2xl font-medium bg-gray-900 ">
                        <h3>Who we are CS Kingdom?</h3>
                    </div>
                    <div className="collapse-content  bg-[#000]">
